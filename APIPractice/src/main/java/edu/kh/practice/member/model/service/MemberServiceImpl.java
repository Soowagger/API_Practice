...
public class MemberServiceImpl implements MemberService {
	...
	// 네이버 회원 가입
	@Override
	public int naverSignup(Member naverNewMember) {
		
		String encPw = bcrypt.encode(naverNewMember.getMemberPw()); 
		
		naverNewMember.setMemberPw(encPw);
		
		return mapper.naverSignup(naverNewMember);
	}
